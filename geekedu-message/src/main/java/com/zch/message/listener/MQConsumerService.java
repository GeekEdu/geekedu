...
public class MQConsumerService {
    ...
    @Service
    @RocketMQMessageListener(topic = "CON_TEST_TOPIC", selectorExpression = "tag1", consumerGroup = "Con_Group_One")
    ...
    @Service
    @RocketMQMessageListener(topic = "CON_TEST_TOPIC", consumerGroup = "Con_Group_Two")
    ...
    @Service
    @RocketMQMessageListener(topic = "CON_TEST_TOPIC", selectorExpression = "tag2", consumerGroup = "Con_Group_Three")
