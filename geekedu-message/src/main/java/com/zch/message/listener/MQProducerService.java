...
//    private Integer messageTimeOut;
    ...
    // 建议正常规模项目统一用一个TOPIC
    private static final String topic = "CON_TEST_TOPIC";
    ...
    public void sendDelayMsg(String msgBody, int delayLevel) {
        rocketMQTemplate.syncSend(topic, MessageBuilder.withPayload(msgBody).build(), 1000, delayLevel);
    }
     ...
     */
    public SendResult sendTagMsg(Object msgBody, String tag) {
