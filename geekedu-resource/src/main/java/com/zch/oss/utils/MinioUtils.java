...
import com.zch.oss.config.MinioConfig;
import io.minio.*;
...
public class MinioUtils {
    ...
    private String generateNewFileName(String originalFileName) {
        // 1. 获取后缀
        String suffix = com.zch.common.core.utils.StringUtils.subAfter(originalFileName, ".", true);
        // 3. 和路径拼接生成新文件名
        return "/course/" + UUID.randomUUID().toString(true) + "." + suffix;
    }
