...
import com.zch.oss.adapter.tencent.TencentFileStorage;
import com.zch.oss.adapter.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "geekedu.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "geekedu.platform", name = "media", havingValue = "TENCENT")
    public MediaStorageAdapter tencentMediaStorage(VodClient tencentVodClient, TencentProperties properties){
        return new TencentMediaStorage(tencentVodClient, properties);
    }

    @Bean
    @ConditionalOnProperty(prefix = "geekedu.platform", name = "file", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "geekedu.platform", name = "file", havingValue = "TENCENT")
    public FileStorageAdapter tencentFileStorage(
